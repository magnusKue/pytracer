...
class Parser:
    def __init__(self, defaultSamples, defaultAR, defaultImageWidth, defaultBounceCap, defaultDest, defaultPreview) -> None:
        ...
        self.parser.add_argument('--preview', "-p", "-prev",     type=str2bool, default=defaultPreview,   help=f'{Fore.GREEN}Choose if you want a live pygame render preview. {Fore.RED}Default is true{Style.RESET_ALL}')
